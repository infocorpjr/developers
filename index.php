            ...
            <ul class="pnavbar-top">
                <li class="pnavbar-top__up">
                    <a class="pnavbar-top__up--link" href="#featured">
                        <svg class="pnavbar-top__up--icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="pbox__middle--content">
            ...
            <div class="swiper-container swiper__container">
                ...
                <div class="swiper-wrapper swiper__container--wrapper">
                    <!-- Slides -->
                    <?php $projects = array_diff(scandir('testing'), array('.', '..', 'backup', 'index.php')); ?>
                    <?php foreach ($projects as $project): ?>
                        <div class="swiper-slide swiper__container--slide">
                            <a href="<?php echo "testing/$project" ?>"><?php echo "$project" ?></a>
                        </div>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <ul class="pnavbar-bottom">
                ...
                <li class="pnavbar-bottom__down">
                    <a class="pnavbar-bottom__down--link" href="#dev">
                        <svg class="pnavbar-bottom__down--icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 489.6 489.6" style="enable-background:new 0 0 489.6 489.6;"
                             xml:space="preserve">
                            <g>
    ...
    <div class="pbox__middle">
        <div class="pbox__middle--content">
            ...
            <div class="swiper-container swiper__container">
                ...
                <div class="swiper-wrapper swiper__container--wrapper">
                    <!-- Slides -->
                    <?php $projects = array_diff(scandir('developing'), array('.', '..', 'backup', 'index.php')); ?>
                    <?php foreach ($projects as $project): ?>
                        <div class="swiper-slide swiper__container--slide">
                            <a href="<?php echo "developing/$project" ?>"><?php echo "$project" ?></a>
                        </div>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <!--
            <div class="swiper-scrollbar swiper__scrollbar"></div>
            -->
        </div>
    </div>
    <div class="pbox__bottom">
                    ...
                    <div class="pbox__middle--content pabout__pbox--left">
                        <div class="pabout__pbox--box">
                            ...
                            <p class="pabout__pbox--text">
                                ...
                                para você e sua empresa. Somos apaixonados pelo que fazemos, no ritmo de sempre aprender
                                e
                            ...
                            <p class="pabout__pbox--links">
                                ...
                                <a class="pabout__pbox--link" href="#projects">Teste</a>
                                <a class="pabout__pbox--link" href="#dev">Desenvolvimento</a>
                            </p>
                        </div>
                    </div>
